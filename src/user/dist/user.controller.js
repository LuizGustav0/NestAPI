...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.create = function (_a) {
        var email = _a.email, name = _a.name, password = _a.password;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, { email: email, name: name, password: password }];
            });
        });
    };
    ...
    UserController.prototype.show = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, { user: {}, id: id }];
            });
        });
    };
    UserController.prototype.update = function (_a, id) {
        var email = _a.email, name = _a.name, password = _a.password;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, {
    ...
    UserController.prototype.updateParcial = function (_a, id) {
        var email = _a.email, name = _a.name, password = _a.password;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, {
    ...
    __decorate([
        common_1.Patch(":id"),
        __param(0, common_1.Body()), __param(1, common_1.Param("id", common_1.ParseIntPipe))
    ], UserController.prototype, "updateParcial");
    __decorate([
        common_1.Delete(":id"),
        __param(0, common_1.Param("id", common_1.ParseIntPipe))
